...
$Id: Distribution.pm 16110 2009-05-29 17:09:13Z medwards $
...
$VERSION = sprintf("%0.4f",('$HeadURL: http://svn.nasba.dev/Voodoo/trunk/Voodoo/Install/Distribution.pm $' =~ m!(\d+\.\d+)!)[0]||10);
