...
#  VERSION
# 
# $Id: signed_decimal.pm 17534 2009-07-13 20:22:03Z medwards $
#
####################################################################################
package Apache::Voodoo::Validate::signed_decimal;
$VERSION = sprintf("%0.4f",('$HeadURL: http://svn.nasba.dev/Voodoo/trunk/Voodoo/Validate/signed_decimal.pm $' =~ m!(\d+\.\d+)!)[0]||10);
